...
namespace Carstec
{
    public partial class administradorAdministradorVisualizar : Form
    {
        public administradorAdministradorVisualizar()
        {
            InitializeComponent();
            ...
            consulta.CommandText = "DESC administrador";
            ...
            consulta.CommandText = "SELECT * FROM administrador";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand consulta = new MySqlCommand();
            consulta.Connection = conectar;
            consulta.CommandText = "SELECT * FROM administrador WHERE " + campo + " LIKE '%" + nomecampo + "%'";
            dataGridView1.Rows.Clear();
            MySqlDataReader resultado = consulta.ExecuteReader();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            administradorAdministradorExcluir administradorAdministradorExcluir = new administradorAdministradorExcluir(id);
            administradorAdministradorExcluir.Show();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            administradorAdministradorAdicionar administradorAdministradorAdicionar = new administradorAdministradorAdicionar(id);
            administradorAdministradorAdicionar.Show();
        }
    }
}
