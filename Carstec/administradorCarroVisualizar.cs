...
namespace Carstec
{
    public partial class administradorCarroVisualizar : Form
    {
        public administradorCarroVisualizar()
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            administradorCarroAdicionar administradorCarroAdicionar = new administradorCarroAdicionar(id);
            administradorCarroAdicionar.Show();
            this.Close();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            administradorCarroAlterar administradorCarroAlterar = new administradorCarroAlterar(id);
            administradorCarroAlterar.Show();
            this.Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            administradorCarroExcluir administradorCarroExcluir = new administradorCarroExcluir(id);
            administradorCarroExcluir.Show();
            this.Close();
        }
    }
}
